...
class Keychain {
    func storeKeyFor(account: String, service: String, key: String) throws {
        if key.isEmpty {
          try deleteKeyFor(account: account, service: service)
          return
        }
    ...
    func getKeyFor(account: String, service: String) throws -> String {
          let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrAccount as String: account,
            kSecAttrService as String: service,
        ...
        func updateKeyFor(account: String, service: String, key: String) throws {
          guard let keyData = key.data(using: .utf8) else {
            print("Error converting value to data.")
            return
          }
    ...
    func deleteKeyFor(account: String, service: String) throws {
      let query: [String: Any] = [
        kSecClass as String: kSecClassGenericPassword,
        kSecAttrAccount as String: account,
        kSecAttrService as String: service
